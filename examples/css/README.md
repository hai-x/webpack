...
```
assets by path *.js 3.39 KiB
  asset output.js 3.3 KiB [emitted] [minimized] (name: main)
...
asset 89a353e9c515885abd8e.png 14.6 KiB [emitted] [immutable] [from: images/file.png] (auxiliary name: main)
Entrypoint main 3.76 KiB (14.6 KiB) = output.js 3.3 KiB output.css 466 bytes 1 auxiliary asset
